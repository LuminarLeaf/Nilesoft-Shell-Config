...
// removed "open in terminal"
modify(where=this.name=="open linux shell here" || this.id==id.open_powershell_window_here
...
// removed "set as background"
modify(mode=mode.multiple
	where=this.id(id.send_to,id.share,id.create_shortcut,id.rotate_left,
